...
module.exports = new SlashCommand({
    ...
    ejecutar: async (client, interaction) => {
        try {
            ...
            const usuariosTexto = interaction.options.getString('users_add')?.trim();
            const cantidadesTexto = interaction.options.getString('elo_win')?.trim();
            ...
            return interaction.editReply({ embeds: [e], components: [goToMatchStatsChannel] });
